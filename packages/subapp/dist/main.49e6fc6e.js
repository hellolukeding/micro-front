(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["subapp-main"] = factory();
	else
		root["subapp-main"] = factory();
})(window, () => {
...
function normalizeTo(location, matches, basename, prependBasename, to, fromRouteId, relative) {
  ...
  let path = router_resolveTo(to ? to : ".", getResolveToMatches(contextualMatches), router_stripBasename(location.pathname, basename) || location.pathname, relative === "path");
...
function render(props) {
  ...
  var dom;
  if (container) {
    dom = container.querySelector("#root");
  } else {
  ...
  root.render( /*#__PURE__*/react.createElement(BrowserRouter, {
    basename: window.__POWERED_BY_QIANKUN__ ? "/subapp" : "/"
